...
function ParsePlayerCoords()
{
    ...
    neighborBtns = document.evaluate("//td[@class='cp']/table[@class='c']/tbody/tr/td//form/input[@name='v']", document, null, XPathResult.UNORDERED_NODE_SNAPSHOT_TYPE, null);
    ...
    return [parseInt(coords[0], 10) + offset, parseInt(coords[1], 10) + 1];
}
...
function MakeWorldMap(suburbCol, suburbRow, id)
{
    ...
    for(i = 0; i < 10; i++)
    {
        ...
        for(j = 0; j < 10; j++)
        {
            ...
            suburbTD.setAttribute("onmouseover","document.getElementById('w_map_text"+id+"').innerHTML='" + suburbName + "'");
            suburbTD.setAttribute("onmouseout","document.getElementById('w_map_text"+id+"').innerHTML=''");
...
function MakeSuburbMap(col, row, id)
{
    var blockCol, blockRow, blockCoord, blockInfo, blockType, blockLink, blockName, i, j, mapCaption, suburbMapTable, suburbName, suburbTD, suburbTR;
  	...
  	var suburbCol = Math.floor(col/10);
  	var suburbRow = Math.floor(row/10);
    ...
    for(i = 0; i < 10; i++)
    {
        ...
        for(j = 0; j < 10; j++)
        {
            ...
            {
                suburbTD.setAttribute("style","height:15px;width:11px;border:1px solid red;background-color:red;");
            }
            ...
            suburbTD.setAttribute("onmouseover","wmt=document.getElementById('w_map_text"+id+"');wmt.innerHTML='" + blockCoord + blockName + "';wmt.style.textAlign='left';");
            suburbTD.setAttribute("onmouseout","wmt=document.getElementById('w_map_text"+id+"');wmt.innerHTML='';wmt.style.textAlign='right';");
        }
    }
...
function MakeUDMapTable(suburbtable, worldtable, id)
{
    ...
    suburbCell.setAttribute("style","vertical-align:bottom;width:140px;");
    ...
    mapTextDiv.setAttribute("style","width:210px;height:15px;text-align:right;");
    mapTextDiv.id="w_map_text"+id;
...
function Search(event){
  ...
  if(x != -1 && y != -1){
    ...
    for(var i = 0; i < searchBox.parentElement.children.length; i++){
      var child = searchBox.parentElement.children[i];
      if(child === searchBox){
        break;
      }
    }
    
    while(searchBox.parentElement.children.length > i + 1){
      searchBox.parentElement.removeChild(searchBox.parentElement.children[i+1]);
    }
    
    var sub_x = Math.floor(x/10);
    var sub_y = Math.floor(y/10);
    
    var span = document.createElement("span");    
    span.innerHTML = directions(player.col, player.row, x, y);
    searchBox.parentElement.appendChild(span)
    var suburbTable = MakeSuburbMap(x, y, 1);
    var worldTable = MakeWorldMap(sub_x, sub_y, 1);
		MakeUDMapTable(suburbTable, worldTable, 1);
  }
...
function MakeSearch(){  
  ...
  searchBox.innerHTML = "<table style=\"padding-left:4px;padding-right:4px;border:4px solid #445544;background-color:#556655;font-family:trebuchet ms, verdana;width:100%;margin-top:5px;margin-bottom:5px;\"><tr><td style=\"width:100%\"><input style=\"width:100%\" id=\"search_input\"></input></td><td><button type=\"submit\">Search</button></td></tr></table>";
  searchBox.addEventListener("submit", Search);
  var cell = document.querySelector("td.cp");
...
if(coords != null)
{
    ...
    suburbTable = MakeSuburbMap(player.col, player.row, 0);
    worldTable = MakeWorldMap(player.suburbCol, player.suburbRow, 0);

    // Add the UI elements to the page
    MakeUDMapTable(suburbTable, worldTable, 0);
  	MakeSearch();
}
